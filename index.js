...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀:
/*
Nested function have access to variables outside it scope. Whatever variables the myFunction have, it can be passed down to the nested function.
*/
...
function USApop() {
  let usPopulation = zooAnimals.reduce(function (accumulator, item) {
